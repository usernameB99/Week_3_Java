        ...
        do {   // all
            do {
                do {
                    ...
                    sc = new Scanner(System.in);// warum überspringt wenn nicht nochmal sc initialisiert??
            ...
            } while (menuechoice < 48 || menuechoice > 51);
            ...
            //-------------------------------------------------------------------------
                ...
                if (whosfirst) {
                    System.out.println("Spieleer 1 fängt an.");
                } else {
